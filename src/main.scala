// Nlp Text Summarization Service

/*
A microservice for abstractive text summarization using state-of-the-art NLP models, developed in Scala with Play Framework and deployed via Docker.
*/
...
object Nlptextsummarizationservice {
  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder
      .appName("Nlp Text Summarization Service App")
      .master("local[*]")
      .getOrCreate()
